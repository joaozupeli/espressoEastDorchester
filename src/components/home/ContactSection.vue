...
function onSubmit() {
  const ig = clinic.instagramUrl || clinic.social.instagram
      ...
      <div class="contact__grid">
        <div class="contact__info">
          ...
          <div data-anim class="info">
            ...
            <p class="info__value">
              <a :href="clinic.instagramUrl || clinic.social.instagram">{{ clinic.phone }}</a><br />
              <a :href="clinic.instagramUrl || clinic.social.instagram">{{ clinic.email }}</a>
            </p>
          </div>
        ...
        <form data-anim class="form" @submit.prevent="onSubmit">
          ...
          <label class="field">
            ...
            <select v-model="form.specialty" required>
              <option value="" disabled>Pick a drink</option>
