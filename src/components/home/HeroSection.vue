...
const facts = [
  ...
  { label: 'Team', value: `${clinic.stats[2].value} on the team` },
]
      ...
      <div ref="aside" class="hero__grid">
        <div class="hero__intro">
          ...
          <div data-intro class="hero__actions">
            <a class="btn btn--solid" :href="clinic.instagramUrl || clinic.social.instagram" target="_blank" rel="noopener noreferrer">
